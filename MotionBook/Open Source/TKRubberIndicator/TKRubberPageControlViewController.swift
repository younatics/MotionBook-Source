...
class TKRubberPageControlViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        page.addTarget(self, action: #selector(TKRubberPageControlViewController.targetActionValueChange(_:)), for: UIControlEvents.valueChanged)
