...
class JTMaterialTransitionViewController: UIViewController {
    ...
    func createPresentControllerButton () {
        ...
        presentControllerButton.backgroundColor = UIColor(red: 86.0 / 256.0, green: 188.0 / 256.0, blue: 138 / 256.0, alpha: 1.0)
    ...
    @objc func didPresentControllerButtonTouch () {
		 let controller = JTMaterialTransitionSecondViewController()
